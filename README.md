...
> ⚠️ **预发布版本**：当前最新为 **`v0.9.5-rc.1`**（release candidate，1.0 正式版之前；已支持 Paper 1.21.11 与 26.1 / 26.2 多版本）。功能已基本完整，正在做实机测试与打磨，可能还有未发现的问题。欢迎试用并反馈。
...
当前最新版本是预发布 **`v0.9.5-rc.1`**（支持 Paper 1.21.11 + 26.x，一份 jar 通吃）。
