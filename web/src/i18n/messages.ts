...
export const messages = {
    zh: {
        ...
        properties: {
            ...
            opacity: '不透明度',
            opacityTip: '元素不透明度。MC 调色板下 = 颜色与下方像素叠加变浅，不是真透明',
            blendMode: '混合方式',
            blendModeTip: '元素与下层颜色的混合方式（搭配 dither 使用效果更柔和）',
            renderMode: '渲染样式',
            renderModeTip: '决定颜色如何映射到 MC 地图调色板（清晰 vs 抖动柔和）',
            renderModeClean: '清晰量化',
            renderModeDither: '抖动柔和',
            // M24-A 新增：字段悬停说明
            fontIdLabel: '字体',
        ...
        fill: {
            ...
            removeStop: '删除色标',
            ditherLabel: '抖动柔化',
            ditherTip: '用 Bayer 4×4 有序抖动打散渐变条带：像素更碎，但过渡更细腻（适合 MC 调色板）',
        },
        snap: {
            settings: '智能对齐设置',
            enable: '启用智能对齐',
        ...
        brush: {
            ...
            dither: '抖动柔化',
            ditherTip: '渲染时跑一遍 Bayer 4×4 抖动，让笔触在 MC 调色板上看起来更柔和',
        ...
        image: {
            ...
            uploading: '上传中…',
            uploadTip: '上传图片（点击 / 拖到画布 / Ctrl+V 粘贴）',
    ...
    en: {
        ...
        properties: {
            ...
            opacity: 'Opacity',
            opacityTip: 'Element opacity. On the MC palette: blends with pixels below and looks lighter — not real transparency',
            blendMode: 'Blend mode',
            blendModeTip: 'How this element mixes with layers below (combines well with dither for softer looks)',
            renderMode: 'Render mode',
            renderModeTip: 'How colors get mapped to the MC map palette (sharp vs. dithered smooth)',
            renderModeClean: 'Crisp quantize',
            renderModeDither: 'Dithered (smooth)',
        ...
        fill: {
            ...
            ditherLabel: 'Dither (soften)',
            ditherTip: 'Bayer 4×4 ordered dither: breaks up gradient bands with periodic noise — rougher pixels, smoother transitions (looks great on MC palette)',
        },
        snap: {
        ...
        brush: {
            ...
            dither: 'Dither (soften)',
            ditherTip: 'Apply Bayer 4×4 dither at render time so strokes look softer on the MC palette',
        ...
        image: {
            ...
            uploading: 'Uploading…',
            uploadTip: 'Upload an image (click / drag onto canvas / Ctrl+V paste)',
            uploadFailed: (status: number, msg: string) =>
