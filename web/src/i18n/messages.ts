    ...
    zh: {
        ...
        script: {
            ...
            soundNames: {
                ...
                anvilUse: '使用铁砧',
                leverClick: '拉杆开关',
                dispenserDispense: '发射器发射',
                bellUse: '敲钟',
                chestOpen: '打开箱子',
                beaconActivate: '激活信标',
                enderDragonGrowl: '末影龙咆哮',
                witherSpawn: '凋灵生成',
                lightningThunder: '雷鸣',
                fireworkLaunch: '烟花升空',
                villagerYes: '村民同意',
        ...
        timeline: {
            ...
            dockAddKeyframe: '在播放头给这个元素打一个关键帧',
            autoKeyframe: '自动加帧：开着时，在画布上拖动 / 缩放元素就会在播放头记下一个关键帧（直接拉出起点和终点）',
            dockSettings: '时间轴设置',
            dockDelete: '删除时间轴',
    ...
    en: {
        ...
        script: {
            ...
            param: {
                ...
                noTimelines: 'This wall has no timelines yet',
            ...
            soundNames: {
                ...
                noteBell: 'Note block · bell',
                notePling: 'Note block · pling',
                noteBass: 'Note block · bass',
                noteBanjo: 'Note block · banjo',
                noteChime: 'Note block · chime',
                xpOrbPickup: 'XP orb pickup',
                playerLevelup: 'Player level up',
                itemPickup: 'Item pickup',
                playerHurt: 'Player hurt',
                anvilLand: 'Anvil land',
                anvilUse: 'Anvil use',
                leverClick: 'Lever click',
                dispenserDispense: 'Dispenser dispense',
                bellUse: 'Bell ring',
                chestOpen: 'Chest open',
                beaconActivate: 'Beacon activate',
                enderDragonGrowl: 'Ender dragon growl',
                witherSpawn: 'Wither spawn',
                lightningThunder: 'Thunder',
        ...
        timeline: {
            ...
            dockAddKeyframe: 'Add a keyframe for this element at the playhead',
            autoKeyframe: 'Auto keyframe: when on, dragging / resizing an element on the canvas records a keyframe at the playhead (just drag out the start and end)',
