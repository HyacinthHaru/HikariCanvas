...
| 0.7.1 | **体验优化**(预览框「幽灵拖动设目标坐标」深度3 + 友好元素积木 8 个 + 新动作 7 + 新触发器 3〔右键墙/离开区域/退服〕+ 有界循环「重复N次」+ 协议 v5；OnCommand 推迟 0.7.2；设计总纲 `docs/scripting-0.7.1.md`，E1-E9 已固化 2026-06-11) | ~150h | **已立项**(brainstorming 完，设计总纲落地，待开工) |
