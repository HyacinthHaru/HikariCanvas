...
- **P4（28h）** ✅ **2026-05-19 完成**。Plugin Push API + 示例插件：
  ...
  - **6 commit**（O `10eeda1` / S `24c16f3` / P `3d8d214` / R `e5158ce` / Q `b227b5c` / T `<本 commit>`）/ **660 backend + 93 frontend test 全绿** / shadow jar 152 MB / 0 baseline 漂移
