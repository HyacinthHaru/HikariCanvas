 ...
 *
 * <p>统一字段 {@link #opacity()} / {@link #blendMode()} / {@link #renderMode()}
 * 详见 {@code docs/architecture.md §10.5}。元素集：</p>
 *
 * <ul>
 *   <li>{@code text} / {@code rect}：{@link TextElement} / {@link RectElement}</li>
 *   <li>{@code icon}：{@link IconElement}</li>
 ...
 *   <li>{@code brush}：笔触，含 RDP 简化后的采样点 + 压感（{@link BrushStrokeElement}）</li>
 *   <li>{@code image}：位图图片，sha256[:16] 内容寻址 + 可选 SVG path 蒙版（{@link ImageElement}）</li>
 * </ul>
 *
